...
exports.n = nextTick;
exports.o = elementStyle;
exports.p = elementNextAll;
exports.q = elementPrevAll;
exports.r = animateCSSModeScroll;
exports.s = setCSSProperty;
exports.t = showWarning;
exports.u = extend;
exports.v = deleteProps;
...
function updateSize() {
  ...
  // Subtract paddings
  width = width - parseInt((0, _utils.o)(el, 'padding-left') || 0, 10) - parseInt((0, _utils.o)(el, 'padding-right') || 0, 10);
  height = height - parseInt((0, _utils.o)(el, 'padding-top') || 0, 10) - parseInt((0, _utils.o)(el, 'padding-bottom') || 0, 10);
...
function updateSlides() {
  ...
  for (let i = 0; i < slidesLength; i += 1) {
    ...
    if (slides[i] && (0, _utils.o)(slide, 'display') === 'none') continue; // eslint-disable-line
...
function updateSlidesClasses() {
  ...
  if (activeSlide) {
    ...
    if (gridEnabled) {
      ...
      // Next Slide
      nextSlide = (0, _utils.p)(activeSlide, `.${params.slideClass}, swiper-slide`)[0];
      ...
      // Prev Slide
      prevSlide = (0, _utils.q)(activeSlide, `.${params.slideClass}, swiper-slide`)[0];
...
function loopCreate(slideRealIndex) {
  ...
  if (shouldFillGroup) {
    if (params.loopAddBlankSlides) {
      ...
      (0, _utils.t)('Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
    }
    initSlides();
    ...
    if (params.loopAddBlankSlides) {
      ...
      (0, _utils.t)('Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
    }
    initSlides();
  } else {
    initSlides();
...
function loopFix(_temp) {
  ...
  if (slides.length < slidesPerView + loopedSlides) {
    (0, _utils.t)('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters');
  } else if (gridEnabled && params.grid.fill === 'row') {
    (0, _utils.t)('Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`');
  }
...
function setBreakpoint() {
  ...
  (0, _utils.u)(swiper.params, breakpointParams);
...
function moduleExtendParams(params, allModulesParams) {
  return function extendParams(obj) {
    ...
    if (typeof moduleParams !== 'object' || moduleParams === null) {
      (0, _utils.u)(allModulesParams, obj);
      return;
    }
...
class Swiper {
  constructor() {
    ...
    if (!params) params = {};
    params = (0, _utils.u)({}, params);
    if (el && !params.el) params.el = el;
    const document = (0, _ssrWindowEsm.g)();
    if (params.el && typeof params.el === 'string' && document.querySelectorAll(params.el).length > 1) {
      const swipers = [];
      document.querySelectorAll(params.el).forEach(containerEl => {
        const newParams = (0, _utils.u)({}, params, {
          el: containerEl
        });
    ...
    const swiperParams = (0, _utils.u)({}, defaults, allModulesParams);

    // Extend defaults with passed params
    swiper.params = (0, _utils.u)({}, swiperParams, extendedDefaults, params);
    swiper.originalParams = (0, _utils.u)({}, swiper.params);
    swiper.passedParams = (0, _utils.u)({}, params);
  ...
  mount(element) {
    ...
    Object.assign(swiper, {
      ...
      mounted: true,
      // RTL
      rtl: el.dir.toLowerCase() === 'rtl' || (0, _utils.o)(el, 'direction') === 'rtl',
      rtlTranslate: swiper.params.direction === 'horizontal' && (el.dir.toLowerCase() === 'rtl' || (0, _utils.o)(el, 'direction') === 'rtl'),
      wrongRTL: (0, _utils.o)(wrapperEl, 'display') === '-webkit-box'
    });
    return true;
  }
  init(el) {
  ...
  static extendDefaults(newDefaults) {
    (0, _utils.u)(extendedDefaults, newDefaults);
  }
...
function Pagination(_ref) {
  ...
  function onBulletClick(e) {
    ...
    e.preventDefault();
    const index = (0, _utils.h)(bulletEl) * swiper.params.slidesPerGroup;
    if (swiper.params.loop) {
    ...
    if (params.type === 'bullets' && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
      ...
      if (el.length > 1) {
        bullets.forEach(bullet => {
          const bulletIndex = (0, _utils.h)(bullet);
...
function Scrollbar(_ref) {
  ...
  function init() {
    ...
    if (el) {
      el.classList[swiper.enabled ? 'remove' : 'add'](...(0, _utils.i)(swiper.params.scrollbar.lockClass));
    }
  }
  function destroy() {
    const params = swiper.params.scrollbar;
    ...
    if (el) {
      el.classList.remove(...(0, _utils.i)(swiper.isHorizontal() ? params.horizontalClass : params.verticalClass));
    }
    disableDraggable();
  }
  on('changeDirection', () => {
  ...
  const enable = () => {
    swiper.el.classList.remove(...(0, _utils.i)(swiper.params.scrollbar.scrollbarDisabledClass));
    if (swiper.scrollbar.el) {
      swiper.scrollbar.el.classList.remove(...(0, _utils.i)(swiper.params.scrollbar.scrollbarDisabledClass));
    }
    init();
    updateSize();
    setTranslate();
  ...
  const disable = () => {
    swiper.el.classList.add(...(0, _utils.i)(swiper.params.scrollbar.scrollbarDisabledClass));
    if (swiper.scrollbar.el) {
      swiper.scrollbar.el.classList.add(...(0, _utils.i)(swiper.params.scrollbar.scrollbarDisabledClass));
    }
    destroy();
  };
...
function Zoom(_ref) {
  ...
  function onTouchMove(e) {
    ...
    if (!image.isMoved) {
      ...
      image.startX = (0, _utils.j)(gesture.imageWrapEl, 'x') || 0;
      image.startY = (0, _utils.j)(gesture.imageWrapEl, 'y') || 0;
    ...
    swiper.pagination.bullets.forEach(bulletEl => {
      if (swiper.params.pagination.clickable) {
        ...
        if (!swiper.params.pagination.renderBullet) {
          ...
          addElLabel(bulletEl, params.paginationBulletMessage.replace(/\{\{index\}\}/, (0, _utils.h)(bulletEl) + 1));
        }
      }
...
function Thumb(_ref) {
  ...
  function init() {
    ...
    } else if ((0, _utils.l)(thumbsParams.swiper)) {
...
let reviews = exports.reviews = [{
  name: "2016-2017",
  position: "Eraafidin  High School",
  review: "High school Diploma in science with a specialization in life and earth sciences"
}, {
  name: "2017-2019",
  position: "NTIC 2 sidi maarouf Casablanca",
  review: "Diploma in specialized computer development"
}, {
  name: "2021 - 2022",
  position: "Majorel Morocco-customer Service",
  review: "Handling Inbound Calls & Responding to customer inquiries & Mail Tracking and Follow-Up "
}, {
  name: "2022 - 2023",
  position: "Massad Group-Shopify Developer - Saudi Arabia",
  review: "Seo Optimization & Landing Pages & integrating Payment Gateways"
}, {
  name: "2024 - Present",
  position: "ARk-x Talent FactoryFull Stack Developer",
  review: "Weather App using Javascript & Atm Project using NodeJs & Ecommerce Website Using Mern Stack & currently Working with three js"
}];
...
},{"../internals/shared-store":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/shared-store.js"}],"../node_modules/smooth-scrollbar/node_modules/core-js/internals/to-object.js":[function(require,module,exports) {
'use strict';
var requireObjectCoercible = require('../internals/require-object-coercible');
...
},{}],"../node_modules/smooth-scrollbar/node_modules/core-js/internals/is-object.js":[function(require,module,exports) {
'use strict';
...
},{"../internals/is-object":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/is-object.js"}],"../node_modules/smooth-scrollbar/node_modules/core-js/internals/a-possible-prototype.js":[function(require,module,exports) {
'use strict';
...
},{"../internals/is-possible-prototype":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/is-possible-prototype.js"}],"../node_modules/smooth-scrollbar/node_modules/core-js/internals/object-set-prototype-of.js":[function(require,module,exports) {
'use strict';
...
},{"../internals/classof-raw":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/classof-raw.js","../internals/to-indexed-object":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/to-indexed-object.js","../internals/object-get-own-property-names":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/object-get-own-property-names.js","../internals/array-slice":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/array-slice.js"}],"../node_modules/smooth-scrollbar/node_modules/core-js/internals/array-buffer-non-extensible.js":[function(require,module,exports) {
'use strict';
...
},{"../modules/es.map.constructor":"../node_modules/smooth-scrollbar/node_modules/core-js/modules/es.map.constructor.js"}],"../node_modules/smooth-scrollbar/node_modules/core-js/internals/map-helpers.js":[function(require,module,exports) {
'use strict';
var uncurryThis = require('../internals/function-uncurry-this');
...
},{"../internals/function-uncurry-this":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/function-uncurry-this.js"}],"../node_modules/smooth-scrollbar/node_modules/core-js/modules/es.map.group-by.js":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
var uncurryThis = require('../internals/function-uncurry-this');
var aCallable = require('../internals/a-callable');
...
},{"../internals/export":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/export.js","../internals/function-uncurry-this":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/function-uncurry-this.js","../internals/a-callable":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/a-callable.js","../internals/require-object-coercible":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/require-object-coercible.js","../internals/iterate":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/iterate.js","../internals/map-helpers":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/map-helpers.js","../internals/is-pure":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/is-pure.js"}],"../node_modules/smooth-scrollbar/node_modules/core-js/internals/object-to-string.js":[function(require,module,exports) {
'use strict';
var TO_STRING_TAG_SUPPORT = require('../internals/to-string-tag-support');
var classof = require('../internals/classof');
...
},{"../../modules/es.array.iterator":"../node_modules/smooth-scrollbar/node_modules/core-js/modules/es.array.iterator.js","../../modules/es.map":"../node_modules/smooth-scrollbar/node_modules/core-js/modules/es.map.js","../../modules/es.map.group-by":"../node_modules/smooth-scrollbar/node_modules/core-js/modules/es.map.group-by.js","../../modules/es.object.to-string":"../node_modules/smooth-scrollbar/node_modules/core-js/modules/es.object.to-string.js","../../modules/es.string.iterator":"../node_modules/smooth-scrollbar/node_modules/core-js/modules/es.string.iterator.js","../../internals/path":"../node_modules/smooth-scrollbar/node_modules/core-js/internals/path.js"}],"../node_modules/smooth-scrollbar/node_modules/core-js/modules/es.set.constructor.js":[function(require,module,exports) {
'use strict';
var collection = require('../internals/collection');
var collectionStrong = require('../internals/collection-strong');
...
//Exp Swipper 
_swiper.default.use([_modules.Pagination, _modules.Navigation]);
...
},{"gsap":"../node_modules/gsap/index.js","swiper":"../node_modules/swiper/swiper.mjs","swiper/modules":"../node_modules/swiper/modules/index.mjs","./data":"assets/js/data.js","imagesloaded":"../node_modules/imagesloaded/imagesloaded.js","smooth-scrollbar":"../node_modules/smooth-scrollbar/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
