...
const texture1=loader.load(images.bg18);
const texture2=loader.load(images.bg14);
const texture3=loader.load(images.bg13);
const texture4=loader.load(images.bg15);
...
class Shaded{
    ...
    render(){
        ...
        this.mesh.position.set(this.offset.x-window.innerWidth/2,
        ...
        this.hovered ?(this.uniforms.uAlpha.value=lerp(this.uniforms.uAlpha.value,1.0,.1))
         :(this.uniforms.uAlpha.value=lerp(
            this.uniforms.uAlpha.value,0.0,.1))
